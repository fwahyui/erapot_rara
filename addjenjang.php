  ...
  <div class="col-lg-12">
	  <section class="panel">
		  <div class="panel-body">
			  <div class="form">
				  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="simpanjenjang.php">
					  
					  <div class="form-group ">
						  <label for="cemail" class="control-label col-lg-2">Jenjang Sekolah <span class="required">*</span></label>
						  <div class="col-lg-10">
