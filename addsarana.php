...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-files-o"></i>Entry Data Sarana Sekolah</h3>
		<ol class="breadcrumb">
			<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
			<li><i class="fa fa-files-o"></i>Entry  Data Sarana Sekolah</li>
		</ol>
	</div>
</div>
<div class="row">
	  ...
	  <section class="panel">
		  <div class="panel-body">
			  <div class="form">
				  ...
				  action="simpansarana.php?jenjang=<?php echo $jenjang;?>">
					  ...
					  <div class="form-group ">
						  <label for="cname" class="control-label col-lg-2">Sarana <span class="required">*</span></label>
						  <div class="col-lg-10">
							<select class="form-control m-bot15"  name="sarpras">
								<?php
								include("koneksi.php");
					  ...
					  <div class="form-group ">
						  <label for="cemail" class="control-label col-lg-2">Jumlah<span class="required">*</span></label>
						  <div class="col-lg-10">
							  <input class="form-control " id="cemail" type="text" name="Jumlah" />
						  </div>
					  </div>
					  <div class="form-group">
